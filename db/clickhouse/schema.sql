-- Create Event
CREATE TABLE oravo.website_event
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- stats hourly
CREATE TABLE oravo.website_event_stats_hourly
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- revenue
CREATE TABLE oravo.website_revenue
(
    website_id UUID,
    session_id UUID,
    event_id UUID,
...
CREATE MATERIALIZED VIEW oravo.website_revenue_mv
TO oravo.website_revenue
AS
SELECT DISTINCT
    ed.website_id,
    ed.session_id,
