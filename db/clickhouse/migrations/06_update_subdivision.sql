-- drop projections
ALTER TABLE oravo.website_event  DROP PROJECTION website_event_url_path_projection;
ALTER TABLE oravo.website_event  DROP PROJECTION website_event_referrer_domain_projection;

--drop view
DROP TABLE oravo.website_event_stats_hourly_mv;

-- rename columns
ALTER TABLE oravo.website_event RENAME COLUMN "subdivision1" TO "region";
ALTER TABLE oravo.website_event_stats_hourly RENAME COLUMN "subdivision1" TO "region";

-- drop columns
ALTER TABLE oravo.website_event DROP COLUMN "subdivision2";

-- recreate projections
ALTER TABLE oravo.website_event 
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE oravo.website_event MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE oravo.website_event MATERIALIZE PROJECTION website_event_referrer_domain_projection;
