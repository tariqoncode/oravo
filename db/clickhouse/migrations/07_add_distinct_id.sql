-- add tag column
ALTER TABLE oravo.website_event ADD COLUMN "distinct_id" String AFTER "tag";
ALTER TABLE oravo.website_event_stats_hourly ADD COLUMN "distinct_id" String AFTER "tag";
ALTER TABLE oravo.session_data ADD COLUMN "distinct_id" String AFTER "data_type";
