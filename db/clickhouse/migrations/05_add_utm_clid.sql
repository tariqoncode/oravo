...
-- stats hourly
CREATE TABLE oravo.website_event_stats_hourly_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE MATERIALIZED VIEW oravo.website_event_stats_hourly_mv_new
TO oravo.website_event_stats_hourly_new
AS
SELECT
    website_id,
    session_id,
...
-- projections
ALTER TABLE oravo.website_event_new
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE oravo.website_event_new MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE oravo.website_event_new MATERIALIZE PROJECTION website_event_referrer_domain_projection;
...
FROM oravo.website_event

-- rename tables
RENAME TABLE oravo.website_event TO oravo.website_event_old;
RENAME TABLE oravo.website_event_new TO oravo.website_event;

RENAME TABLE oravo.website_event_stats_hourly TO oravo.website_event_stats_hourly_old;
RENAME TABLE oravo.website_event_stats_hourly_new TO oravo.website_event_stats_hourly;

RENAME TABLE oravo.website_event_stats_hourly_mv TO oravo.website_event_stats_hourly_mv_old;
RENAME TABLE oravo.website_event_stats_hourly_mv_new TO oravo.website_event_stats_hourly_mv;

-- recreate view
DROP TABLE oravo.website_event_stats_hourly_mv;

CREATE MATERIALIZED VIEW oravo.website_event_stats_hourly_mv
TO oravo.website_event_stats_hourly
AS
SELECT
    website_id,
    session_id,
